...
> [!abstract] 工作台定位
> 这张页是为 `Anne Boleyn` 一案中的“供词如何闭合案件”搭建的中间试问台。  
> 当前其核心结构判断已经沉淀进正式子页 [[7.3.02 QCase_马克·斯密顿供词链与安妮案闭合]]；本页后续仅保留为试问记录与补证入口。
...
- 子案例页：[[7.3.02 QCase_马克·斯密顿供词链与安妮案闭合]]
- 案例页：[[7.3.01 QCase_安妮·博林的倒台]]
- 比较页：[[7.4.01 QCross_安妮案同案人物比较]]
- 话语装置页：[[7.4.02 QCross_誓言、供词、沉默三种话语装置比较]]
...
- `Mark Smeaton`、同案网络和起诉书措辞三条线已经足以支撑正式子页，因此这张工作台的核心使命已经完成，后续仅保留为补证记录。
